...
const workData: Work[] = [
  ...
  },
  {
    ...
    year: "2025",
    desc: "시스템 운영",
    itemList: ["시스템 운영", "시스템 모니터링", "장애 대응", "프로세스 개발"],
    badges: ["Linux", "SPRINGBOOT"],
  },
  {
    title: "P사 S",
    year: "2025",
    desc: "모듈 개발",
    itemList: ["프로세스 개선", "Web, App 대응 개발"],
    badges: ["Linux", "SPRINGBOOT"],
  },
  {
    title: "P사 S",
    year: "2025",
    desc: "Cleaning Process Development",
    itemList: ["Cleaning Process 신규 개발", "권한 별 프로세스 개발"],
    badges: ["Linux", "SPRINGBOOT"],
  },
  {
    title: "P사 푸드관련",
    ...
    itemList: ["손익 관련 시스템 운영"],
    badges: ["Linux", "Mybuilder", "Essbase", "ODI", "Oracle"],
  },
  {
    title: "P사 푸드관련",
    year: "2025",
    desc: "System Maintenance Development",
    itemList: ["사업계획 자동화"],
    badges: ["WebHook", "N8N", "Python"],
  },
  {
    title: "P사 푸드관련",
    year: "2025",
    desc: "Interface Development",
    itemList: ["대량 데이터 인터페이스", "API 개발"],
    badges: ["WebHook", "Python", "FastAPI"],
  },
];
